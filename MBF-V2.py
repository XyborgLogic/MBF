...
def ua_krek():
        rr = random.randint
        model = random.choice(['F320L'])
        ua = (f"Mozilla/5.0 (Linux; Android 5.0.0; LG Build/T3L180; wv)AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/303.0.0.1.126 Mobile Safari/537.36[FBAN/EMA; FBLC/en_US; FBAV/309.0.0.16.451674;]")
        return ua
